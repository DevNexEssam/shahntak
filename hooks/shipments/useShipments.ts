...
export const shipmentKeys = {
    ...
    list: (page: number, limit: number, search: string = "", status: string = "all", type: string = "all", startDate: string = "", endDate: string = "") =>
        [...shipmentKeys.lists(), { page, limit, search, status, type, startDate, endDate }] as const,
...
// Queries
export const useShipments = (page: number = 1, limit: number = 10, search: string = "", status: string = "all", type: string = "all", startDate: string = "", endDate: string = "") => {
    return useQuery({
        queryKey: shipmentKeys.list(page, limit, search, status, type, startDate, endDate),
        queryFn: () => shipmentServices.getShipments(page, limit, search, status, type, startDate, endDate),
