...
import { useUpdateOrder } from '@/hooks/orders/useOrders';
...
export default function EditOrders({ isOpen = true, order, onClose }: EditOrdersProps) {
    ...
    const { mutate: updateOrder, isPending: isSubmitting } = useUpdateOrder();
