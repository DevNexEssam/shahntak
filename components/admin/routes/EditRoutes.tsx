...
const EditRoutes: React.FC<EditRoutesProps> = ({ isOpen = false, onClose, routeData }) => {
            ...
            <div className="relative w-full max-w-2xl bg-surface border border-border rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 border-b border-border flex items-center justify-between bg-surface-muted/50">
                    <div className="flex items-center gap-3.5">
                        ...
                        <div>
                            <h2 className="text-xl font-extrabold text-heading">تعديل بيانات المسار اللوجستي</h2>
                            <p className="text-xs text-body mt-0.5">تحديث مواعيد وتفاصيل خط النقل ({routeData?.from || 'الرياض'} ← {routeData?.to || 'جدة'})</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    type="text"
                                    defaultValue={routeData?.from || 'الرياض (المستودع الرئيسي)'}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    type="text"
                                    defaultValue={routeData?.to || 'جدة (فرع المروة)'}
                                    className="w-full px-4 py-2.5 rounded-xl bg-surface-muted border border-border text-sm text-heading focus:outline-none focus:border-accent"
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    type="text"
                                    defaultValue={routeData?.trips || '١٨ رحلة/يوم'}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    type="text"
                                    defaultValue={routeData?.load || '٩٤٪'}
                                    className="w-full px-4 py-2.5 rounded-xl bg-surface-muted border border-border text-sm text-heading font-latin focus:outline-none focus:border-accent"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                type="text"
                                defaultValue={routeData?.carrier || 'أسطول الشركة الرئيسي'}
                                className="w-full px-4 py-2.5 rounded-xl bg-surface-muted border border-border text-sm text-heading focus:outline-none focus:border-accent"
                            />
                        </div>
                    </div>
