            ...
            <div className="relative w-full max-w-lg bg-surface border border-border rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 border-b border-border flex items-center justify-between bg-surface-muted/50">
                    <div className="flex items-center gap-3.5">
                        ...
                        <div>
                            <h2 className="text-xl font-extrabold text-heading">إضافة ناقل شرك جديد</h2>
                            <p className="text-xs text-body mt-0.5">تسجيل بيانات الناقل المتعاقد معه وتعيين نوع التشغيل والربط</p>
                        </div>
                    </div>
                    ...
                    <div className="p-6 overflow-y-auto space-y-5 flex-1 text-right">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-heading flex items-center gap-1.5">
                                ...
                                اسم الناقل / الشركة الناقلة <span className="text-red-500">*</span>
                            </label>
                            <input
                                type="text"
                                disabled={isSubmitting}
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-heading flex items-center gap-1.5">
                                ...
                                نوع الناقل والربط البرمجي <span className="text-red-500">*</span>
                            </label>
                            <select
                                disabled={isSubmitting}
