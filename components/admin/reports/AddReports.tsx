            ...
            <div className="relative w-full max-w-2xl bg-surface border border-border rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 border-b border-border flex items-center justify-between bg-surface-muted/50">
                    <div className="flex items-center gap-3.5">
                        ...
                        <div>
                            <h2 className="text-xl font-extrabold text-heading">Generate New Analytics Report</h2>
                            <p className="text-xs text-body mt-0.5">Set up and customize the logistics performance and revenue report</p>
                        </div>
                    </div>
                ...
                <div className="p-6 overflow-y-auto space-y-6 text-left">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                type="text"
                                placeholder="e.g., SLA On-Time Compliance Report — August"
