...
const subscriptionInvoices: InvoiceItem[] = [
    {
        invId: 'INV-2026-089',
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-surface border border-border text-heading font-bold text-xs hover:bg-surface-muted transition-colors cursor-pointer">
                        <FaDownLong className="w-3.5 h-3.5 text-body" />
                        <span>تصدير إقرار القيمة المضافة</span>
                    </button>
                                ...
                                <tr key={inv.invId} className="hover:bg-surface-muted/40 transition-colors">
                                    ...
                                    <td className="py-4 px-5 text-center">
                                        <div className="flex items-center justify-center gap-2">
                                            ...
                                            <button title="تحميل فاتورة PDF" className="p-1.5 rounded-lg hover:bg-surface-muted border border-border text-body hover:text-heading transition-colors cursor-pointer">
