                    ...
                    {companiesData.map((company) => (
                        ...
                        >
                            ...
                            <div className="px-5 py-3 bg-surface-muted border-t border-border flex items-center justify-between gap-3">
                                ...
                                <button className="p-2 rounded-xl hover:bg-surface border border-transparent hover:border-border text-body hover:text-heading transition-colors">
                                    <FaMonero className="w-4 h-4" />
                                </button>
                            </div>
                                ...
                                {companiesData.map((company) => (
                                    <tr key={company.id} className="hover:bg-surface-muted/30 transition-colors">
                                        ...
                                        <td className="py-4 px-5 text-center">
                                            <button className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface border border-border hover:bg-heading hover:text-white text-xs font-bold transition-colors">
                                                <span>دخول</span>
