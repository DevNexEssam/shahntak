...
> * **استكمال القسمين المتبقين من المرحلة الثالثة لبوابة الشركة (مربوطة بالـ Hooks)**:
>   1. 📊 **قسم التقارير والإحصائيات** (`reports`): `CompanyReports.tsx` وتحليلات الأداء والتقارير المتقدمة.
>   2. ⚙️ **قسم إعدادات الشركة والاشتراك** (`settings`): `CompanySettings.tsx` وإدارة ملف الشركة وتتبع حدود الباقة.
...
* 🔄 **المرحلة الثالثة: بناء وتنميط واجهات بوابة الشركة (تم إنجاز 75% - 6 أقسام من أصل 8)**:
  ...
  * ⏳ **القسمان المتبقيان** (`reports`, `settings`): هدف الجلسة القادمة.
