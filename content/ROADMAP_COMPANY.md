...
> **وقفنا في هذه الجلسة عند**: إتمام وتطبيق **ميزة إنشاء الفواتير اليدوية للشركات وإدارة الضريبة وحظر التكرار (Manual Invoice Creation & Anti-Duplication Safeguard)** بنجاح 100%. يشمل ذلك:
> 1. زر "إنشاء فاتورة جديدة +" ونافذة منسقة ([AddCompanyInvoicePopup.tsx](file:///e:/projects/shahntak/components/company/invoices/AddCompanyInvoicePopup.tsx)).
> 2. حظر تكرار الفواتير لنفس الشحنة من الـ API بنسبة 100% وإظهار الشحنات غير المفوترة فقط بالمنسدلة.
> 3. سحب سعر الشحنة تلقائياً، إتاحة الخصم المالي، وتطبيق وتجميد نسبة ضريبة الشركة المجمدة (`taxRateSnapshot`).
>
